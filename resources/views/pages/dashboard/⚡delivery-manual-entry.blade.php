    ...
    <x-pages::dashboard.layout>
        <div class="border border-accent p-6 rounded-2xl my-6">
            <div class="flex justify-between mb-8">
                ...
                <div>
                    <flux:button variant="outline" href="{{ route('dashboard.delivery') }}" wire:current="dashboard.delivery" wire:navigate>
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="autoComplete_wrapper" wire:ignore>
                            <flux:input wire:model="visiting" id="delivery-manual-entry" label="Delivery For" placeholder="Person being visited" autocomplete="off" />
                        </div>
        ...
        <flux:modal name="delivery-submit-verification" class="w-[1000px]!">
            <div class="space-y-6">
                ...
                <div class="flex justify-end gap-2">
                    <flux:button type="button" x-on:click="$flux.modal('delivery-submit-verification').close()">Cancel</flux:button>
